                ...
                m_message, http_matches, http_pattern, std::regex_constants::match_default))
        {
            ...
            if (http_method != "GET")
            {
                ...
                ss << http_ver << " "
                   ...
                   << "Server: " << phihashminer_get_buildinfo()->project_name_with_version << "\r\n"
...
Json::Value ApiConnection::getMinerStat1()
{
    ...
    jRes[0] = phihashminer_get_buildinfo()->project_name_with_version;  // miner version.
 ...
 *    https://github.com/gangnamtestnet/phihashminer/pull/1232#discussion_r193995891
...
Json::Value ApiConnection::getMinerStatDetail()
{
    ...
    /* Host Info */
    Json::Value hostinfo;
    hostinfo["version"] = phihashminer_get_buildinfo()->project_name_with_version;  // miner version.
