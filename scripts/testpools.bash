...
#
# Testscript to test phihashminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of phihashminer and start running
#
...
# export some vars as "./phihashminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./phihashminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./phihashminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./phihashminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
